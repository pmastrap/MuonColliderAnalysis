...
void plotPDF(){
	...
	n_jets_BIB->SetTitle("Jets per event");
    	...
    	n_jets_BIB->Scale(factor/n_jets_BIB->Integral());
	...
	m_inv_BIB->Scale(factor/m_inv_BIB->Integral());
	...
	eta_BIB->Scale(factor/eta_BIB->Integral());
	...
	E_BIB->GetYaxis()->SetRangeUser(0,0.05);
	E_BIB->Scale(factor/E_BIB->Integral());
	...
	pt_BIB->Scale(factor/pt_BIB->Integral());
	...
	phi_BIB->Scale(factor/phi_BIB->Integral());
	phi_BIB->GetYaxis()->SetRangeUser(0,0.12);
    	...
    	auto legend2 = new TLegend(0.63,0.75,0.97,0.96);
     	...
     	legend2->AddEntry(n_jets_BIB, "H #rightarrow c#bar{c}", "l");
     	//legend2->AddEntry(n_jets_BIB, "#splitline{H #rightarrow c#bar{c} + BIB(10)}{+correction}" , "l");
     	legend2->AddEntry(n_jets, "H #rightarrow b#bar{b}", "l");
     	legend2->SetTextSize(0.04);
	      ...
	      myc1->cd(4);
	      E_BIB->GetYaxis()->SetRangeUser(0,0.055);
	      E_BIB->Draw("s hist");
	      myc1->Update();
