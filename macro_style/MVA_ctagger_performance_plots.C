...
#include "My_Beautiful_Canvas_BDTperform.C"
...
void MVA_ctagger_performance_plots(){
	...
	auto legend0 = new TLegend(0.67,0.77,0.86,0.91);
	...
	auto legend1 = new TLegend(0.17,0.16,0.47,0.39);
	...
	cc->Update();
	cc->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s_contour.png",gr[0]->GetYaxis()->GetTitle()));
	cc->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s_contour.pdf",gr[0]->GetYaxis()->GetTitle()));
	
	auto legend00 = new TLegend(0.30,0.65,0.85,0.70);
	...
	setTDRStyle();
	TCanvas* c_correlation=new TCanvas("c_correlation","c_correlation",10,10,W,H);
	...
	legend00->Draw();
	My_Beautiful_Canvas_BDTperform(c_correlation);
	c_correlation->Update();
	c_correlation->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s_corr.png",correlation_b->GetYaxis()->GetTitle()));
	c_correlation->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s_corr.pdf",correlation_b->GetYaxis()->GetTitle()));
	
	auto legend000= new TLegend(0.55,0.35,0.8,0.60);
	legend000->AddEntry(ROC_CvsB, "c tagger CvsB" , "l");
	legend000->SetTextSize(0.04);
	legend000->SetBorderSize(0);
	setTDRStyle();
	TCanvas* c_ROC_B=new TCanvas("c_ROC_B","c_ROC_B",10,10,W,H);
	gPad->SetLogy();
	ROC_CvsB->GetXaxis()->SetTitle("c-jet efficiency");
	ROC_CvsB->GetYaxis()->SetTitle("b-jet misid. probability");
	ROC_CvsB->Draw("APL");
	legend000->Draw();
	My_Beautiful_Canvas_BDTperform(c_ROC_B);
	c_ROC_B->Update();
	c_ROC_B->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s.png",ROC_CvsB->GetYaxis()->GetTitle()));
	c_ROC_B->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s.pdf",ROC_CvsB->GetYaxis()->GetTitle()));
	
	auto legend0000= new TLegend(0.55,0.35,0.8,0.60);
	legend0000->AddEntry(ROC_CvsL, "c tagger CvsL" , "l");
	legend0000->SetTextSize(0.04);
	legend0000->SetBorderSize(0);
	setTDRStyle();
	TCanvas* c_ROC_L=new TCanvas("c_ROC_L","c_ROC_L",10,10,W,H);
	gPad->SetLogy();
	ROC_CvsL->GetXaxis()->SetTitle("c-jet efficiency");
	ROC_CvsL->GetYaxis()->SetTitle("light-jet misid. probability");
	ROC_CvsL->Draw("APL");
	legend0000->Draw();
	My_Beautiful_Canvas_BDTperform(c_ROC_L);
	c_ROC_L->Update();
	c_ROC_L->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s.png",ROC_CvsL->GetYaxis()->GetTitle()));
	c_ROC_L->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s.pdf",ROC_CvsL->GetYaxis()->GetTitle()));
	
	
	TCanvas* c_eff_CvsB=new TCanvas("c_eff_CvsB","c_eff_CvsB",10,10,W,H);
	eff_c_B->SetMaximum(1.4);
	eff_c_B->GetYaxis()->SetTitle("c tagger CvsB efficiency");
	eff_c_B->GetXaxis()->SetTitle("BDT cut");
	setTDRStyle();
	eff_c_B->Draw("");
	eff_b_B->Draw("same");
	eff_o_B->Draw("same");
	legend0->Draw();
	My_Beautiful_Canvas_BDTperform(c_eff_CvsB);
	c_eff_CvsB->Update();
	c_eff_CvsB->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s.png",eff_c_B->GetYaxis()->GetTitle()));
	c_eff_CvsB->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s.pdf",eff_c_B->GetYaxis()->GetTitle()));
	
	
	TCanvas* c_eff_CvsL=new TCanvas("c_eff_CvsL","c_eff_CvsL",10,10,W,H);
	eff_c_L->SetMaximum(1.4);
	eff_c_L->GetYaxis()->SetTitle("c tagger CvsL efficiency");
	eff_c_L->GetXaxis()->SetTitle("BDT cut");
	setTDRStyle();
	eff_c_L->Draw("");
	eff_b_L->Draw("same");
	eff_o_L->Draw("same");
	legend0->Draw();
	My_Beautiful_Canvas_BDTperform(c_eff_CvsL);
	c_eff_CvsL->Update();
	c_eff_CvsL->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s.png",eff_c_L->GetYaxis()->GetTitle()));
	c_eff_CvsL->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s.pdf",eff_c_L->GetYaxis()->GetTitle()));
	
	TCanvas* c_CvsB = new TCanvas("c_CvsB","c_CvsB",10,10,W,H);
	...
	legend0->Draw();
	My_Beautiful_Canvas_BDTperform(c_CvsB);
	c_CvsB->Update();
	c_CvsB->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s_output.png",h_CvsB_output_c->GetXaxis()->GetTitle()));
	c_CvsB->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s_output.pdf",h_CvsB_output_c->GetXaxis()->GetTitle()));
	
	TCanvas* c_CvsL = new TCanvas("c_CvsL","c_CvsL",10,10,W,H);
	...
	legend0->Draw();
	My_Beautiful_Canvas_BDTperform(c_CvsL);
	c_CvsL->Update();
	c_CvsL->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s_output.png",h_CvsL_output_c->GetXaxis()->GetTitle()));
	c_CvsL->SaveAs(Form("/home/paola/Scrivania/macro/macro_style/Plot_belli/Tagger_Performance/%s_output.pdf",h_CvsL_output_c->GetXaxis()->GetTitle()));
